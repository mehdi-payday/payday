...
public interface IPretService extends IService {
    ...
    /**
     *
     * Trouve tous les prêts de la base de données. La liste est classée par ordre croissant sur sortByPropertyName. Si aucun prêt n'est trouvé, une List vide est retournée.
     *
     * @param connexion La connexion à utiliser
    ...
    /**
     *
     * Trouve les prêts à partir d'un livre. La liste est classée par ordre croissant sur sortByPropertyName. Si aucun prêt n'est trouvé, une List vide est retournée.
     *
     * @param connexion La connexion à utiliser
