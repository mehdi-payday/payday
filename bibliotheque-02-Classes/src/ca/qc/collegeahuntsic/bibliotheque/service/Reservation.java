...
public class Reservation {
	...
	public Reservation(final Connexion cx) throws SQLException {
		...
		this.stmtExisteMembre = cx.getConnection().prepareStatement(
	...
	public boolean existe(final int idReservation) throws SQLException {
		...
		this.stmtExiste.setInt(1, idReservation);
	...
	public ReservationDTO getReservationLivre(final int idLivre) throws SQLException {
		...
		this.stmtExisteLivre.setInt(1, idLivre);
	...
	public ReservationDTO getReservationMembre(final int idMembre) throws SQLException {
		...
		this.stmtExisteMembre.setInt(1, idMembre);
	 ...
	 */
	public void reserver(final int idReservation, final int idLivre, final int idMembre, final String dateReservation)
			throws SQLException {
		this.stmtInsert.setInt(1, idReservation);
		this.stmtInsert.setInt(2, idLivre);
		this.stmtInsert.setInt(3, idMembre);
		this.stmtInsert.setString(4, dateReservation);
	...
	public int annulerRes(final int idReservation) throws SQLException {
		this.stmtDelete.setInt(1, idReservation);
