...
public class GestionPret {
	 ...
	 * transactions.
	 */
	public GestionPret(Livre livre, Membre membre, Reservation reservation) throws BiblioException {
	...
	public void preter(int idLivre, int idMembre, String datePret) throws SQLException, BiblioException, Exception {
		try {
			...
			if (tupleLivre.idMembre != 0)
				throw new BiblioException("Livre " + idLivre + " deja prete a " + tupleLivre.idMembre);
			...
			if (tupleReservation != null)
				throw new BiblioException("Livre r�serv� par : " + tupleReservation.idMembre + " idReservation : "
	...
	public void retourner(int idLivre, String dateRetour) throws SQLException, BiblioException, Exception {
		try {
			...
			if (tupleLivre == null)
				throw new BiblioException("Livre inexistant: " + idLivre);
			if (tupleLivre.idMembre == 0)
				throw new BiblioException("Livre " + idLivre + " n'est pas pr�t� ");
