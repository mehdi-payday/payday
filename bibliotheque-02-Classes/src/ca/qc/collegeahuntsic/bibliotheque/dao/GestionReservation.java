...
public class GestionReservation {
	 ...
	 * transactions.
	 */
	public GestionReservation(Livre livre, Membre membre, Reservation reservation) throws BiblioException {
	...
	public void prendreRes(int idReservation, String datePret) throws SQLException, BiblioException, Exception {
		try {
			...
			if (tupleLivre.idMembre != 0)
				throw new BiblioException("Livre " + tupleLivre.idLivre + " deja pr�t� � " + tupleLivre.idMembre);
			...
			if (tupleMembre.nbPret >= tupleMembre.limitePret)
				throw new BiblioException("Limite de pr�t du membre " + tupleReservation.idMembre + " atteinte");
